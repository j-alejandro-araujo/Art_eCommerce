...
const MAX_RADIUS = 15;
const DEPTH = 2;
const LEFT_COLOR = '2BA3C6';
const RIGHT_COLOR = 'EE2D25';
// const MIDDLE_COLOR = "2BA3C6";
...
const getGradientStop = (ratio) => {
  ...
  // const c2 = MIDDLE_COLOR.match(/.{1,2}/g).map(
  // (oct) => parseInt(oct, 16) * (1 - Math.abs(0.5 - ratio) * 2)
  // );
...
export const pointsOuter = Array.from(
  ...
  const z = randomFromInterval(-DEPTH * 3, DEPTH * 10);
